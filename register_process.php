...
class UserRegistration {
    ...
    private function sendRegistrationEmail($email, $name, $password) {
        ...
        $emailBody .= 'This email contains confidential information and is intended only for the recipient named above.';
        $emailBody .= 'If you have received this email by mistake, please inform us immediately and delete it from your system.<br> ';
